	...
	<nav class="navbar navbar-expand-lg navbar-light bg-light">
		<div class="collapse navbar-collapse" id="navbarColor03">
			<ul class="navbar-nav mr-auto">
				<li class="nav-item active"><a class="nav-link" href="/peekaboo21">Home<span
		...
		<button type="button" class="btn btn-outline-secondary" id="btnAdmin">A.page</button>
		<button type="button" class="btn btn-outline-danger" id="btnAlogout">A.Logout</button>
		</c:when>
